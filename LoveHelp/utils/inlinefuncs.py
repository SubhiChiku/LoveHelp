...
from LoveHelp import pbot as app 
from LoveHelp import arq
from LoveHelp.services.keyboard import Ikb
from LoveHelp.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from LoveHelp.services.tasks import _get_tasks_text, all_tasks, rm_task
from LoveHelp.services.types import InlineQueryResultCachedDocument
from LoveHelp.modules.info import get_chat_info, get_user_info
from LoveHelp.modules.music import download_youtube_audio
from LoveHelp.utils.functions import test_speedtest
from LoveHelp.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Loverobot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Love Robot ❤️](https://t.me/Lovesupport):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
