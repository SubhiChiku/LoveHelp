...
async def _(event):
    ...
    im1 = Image.open("LoveHelp/resources/Love.png")
    if ik.endswith(".tgs"):
        await tbot.download_media(reply, "Love.tgs")
        os.system("lottie_convert.py Love.tgs json.json")
        json = open("json.json", "r")
        jsn = json.read()
        jsn = jsn.replace("512", "2000")
        open = ("json.json", "w").write(jsn)
        os.system("lottie_convert.py json.json Love.tgs")
        file = "Love.tgs"
        os.remove("json.json")
