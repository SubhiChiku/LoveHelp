...
from LoveHelp import DRAGONS as SUDO_USERS
from LoveHelp import pbot
from LoveHelp.modules.sql import forceSubscribe_sql as sql
...
__help__ = """
*Force Subscribe:*
❂ Love can mute members who are not subscribed your channel until they subscribe
