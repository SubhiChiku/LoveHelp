...
import LoveHelp.modules.sql.notes_sql as sql
from LoveHelp import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from LoveHelp.__main__ import DATA_IMPORT
from LoveHelp.modules.helper_funcs.chat_status import user_admin
from LoveHelp.modules.helper_funcs.alternate import typing_action

# from LoveHelp.modules.rules import get_rules
import LoveHelp.modules.sql.rules_sql as rulessql

# from LoveHelp.modules.sql import warns_sql as warnssql
import LoveHelp.modules.sql.blacklist_sql as blacklistsql
from LoveHelp.modules.sql import disable_sql as disabledsql

# from LoveHelp.modules.sql import cust_filters_sql as filtersql
# import LoveHelp.modules.sql.welcome_sql as welcsql
import LoveHelp.modules.sql.locks_sql as locksql
from LoveHelp.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        try:
            ...
            msg.reply_text(
                "Try downloading and uploading the file yourself again, This one seem broLove to me!",
            )
            return
...
def export_data(update, context):
    ...
    with open("LoveHelp{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("LoveHelp{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `LoveHelp-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("LoveHelp{}.backup".format(chat_id))  # Cleaning file
