...
import LoveHelp.modules.sql.feds_sql as sql
...
from LoveHelp.modules.helper_funcs.string_handling import markdown_parser
...
def fed_import_bans(update: Update, context: CallbackContext):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "Try downloading and re-uploading the file, this one seems broLove!",
            )
            return
...
def fed_owner_help(update: Update, context: CallbackContext):
 ...
 • `/fedsubs`*:* Shows the feds your group is subscribed to `(broLove rn)`""",
        parse_mode=ParseMode.MARKDOWN,
    )
