...
from LoveHelp import REM_BG_API_KEY
...
async def _(event):
    ...
    if REM_BG_API_KEY is None:
        await event.reply("`You need API toLove from remove.bg to use this plugin.`")
        return False
    start = datetime.now()
    ...
    if "image" in contentType:
        ...
        await event.reply(
            "remove.bg API returned Errors. Please report to @Lovebotsupport\n`{}".format(
