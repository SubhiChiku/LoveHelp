...
from LoveHelp import LOGGER, TEMP_DOWNLOAD_DIRECTORY, telethn as bot
...
# TaLove from https://github.com/UsergeTeam/Userge-Plugins/blob/master/plugins/memify.py#L64
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./LoveHelp/resources/default.ttf"
